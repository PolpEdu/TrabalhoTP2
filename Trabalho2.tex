...
Resumidamente, atualmente  é essencial ter em conta o tipo de data a codificar na sua codificação, apesar de existirem CODECs não destrutivos para todo o tipo de data em geral, como é o caso da Codificação DEFLATE. 
...
Calculando, depois da compressão o número médio de bits por símbolo usado.
